...
Cikti: submission_v26.csv + submission_v27.csv (0.5*v15 + 0.5*v7)
...
OUT = ROOT / "submissions" / "submission_v26.csv"
OUT_MIX = ROOT / "submissions" / "submission_v27.csv"
...
def main():
    ...
    np.savez(CACHE / "preds_v26.npz", y=y, w_fit=w_fit, years=yr_tr,
