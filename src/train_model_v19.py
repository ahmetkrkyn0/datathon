...
Cikti: submission_v19.csv + submission_v20.csv (0.5*v15 + 0.5*v7)
...
OUT = ROOT / "submissions" / "submission_v19.csv"
OUT_MIX = ROOT / "submissions" / "submission_v20.csv"
...
def main():
    ...
    np.savez(CACHE / "preds_v19.npz", y=y, w_fit=w_fit, years=yr_tr,
