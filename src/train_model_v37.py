...
Cikti: submission_v37.csv + submission_v38.csv (0.5*v15 + 0.5*v7)
...
OUT = ROOT / "submissions" / "submission_v37.csv"
OUT_MIX = ROOT / "submissions" / "submission_v38.csv"
...
def main():
    ...
    np.savez(CACHE / "preds_v37.npz", y=y, w_fit=w_fit, years=yr_tr,
