...
Cikti: submission_v23.csv + submission_v24.csv (0.5*v15 + 0.5*v7)
...
OUT = ROOT / "submissions" / "submission_v23.csv"
OUT_MIX = ROOT / "submissions" / "submission_v24.csv"
...
def main():
    ...
    np.savez(CACHE / "preds_v23.npz", y=y, w_fit=w_fit, years=yr_tr,
