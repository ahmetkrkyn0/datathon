...
Cikti: submission_v30.csv + submission_v31.csv (0.5*v15 + 0.5*v7)
...
OUT = ROOT / "submissions" / "submission_v30.csv"
OUT_MIX = ROOT / "submissions" / "submission_v31.csv"
...
def main():
    ...
    np.savez(CACHE / "preds_v30.npz", y=y, w_fit=w_fit, years=yr_tr,
