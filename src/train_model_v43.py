...
Cikti: submission_v43.csv + submission_v44.csv (0.5*v15 + 0.5*v7)
...
OUT = ROOT / "submissions" / "submission_v43.csv"
OUT_MIX = ROOT / "submissions" / "submission_v44.csv"
...
def main():
    ...
    train["sub2"] = np.load(CACHE / "sub2_oof.npy")
    test["sub2"] = np.load(CACHE / "sub2_test.npy")
    num_cols = num_cols + ["txt_bert2", "txt_bert3", "txt_mdeb", "txt_mm", "txt_xlmr", "sub2"]
    ...
    np.savez(CACHE / "preds_v43.npz", y=y, w_fit=w_fit, years=yr_tr,
