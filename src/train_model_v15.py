...
Cikti: submission_v15.csv + submission_v16.csv (0.5*v15 + 0.5*v7)
...
OUT = ROOT / "submissions" / "submission_v15.csv"
OUT_MIX = ROOT / "submissions" / "submission_v16.csv"
...
def main():
    ...
    np.savez(CACHE / "preds_v15.npz", y=y, w_fit=w_fit, years=yr_tr,
